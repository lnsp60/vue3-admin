<template>
  <el-card>
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input placeholder="请输入站点名称、ID" v-model.trim="formParams.input">
          <template #append>
  ...
  <el-card>
    <el-table :data="tableData" style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-button type="primary" size="small" @click="edit(scope.row)">c</el-button>
            <el-popconfirm title="确认删除当前站点吗?" @confirm="handleDelete(scope.row.id)">
              <template #reference>
