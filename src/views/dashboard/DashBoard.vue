  ...
  <el-row :gutter="5">
    <el-col :span="18">
      ...
      <el-card class="mt">
        ...
        <el-row>
          <el-col :span="8">
            <div ref="chartRef2" style="width: 100%; height: 380px;"></div>
          </el-col>
          <el-col :span="16">
    ...
    <el-col :span="6">
      <el-card>
        ...
        <div ref="chartRef3" style="width: 100%; height: 200px;"></div>
      </el-card>
      <el-card class="mt">
        <template #header>
          <div class="card-header">
  ...
  series: [
    {
      name: '营收占比',
      type: 'pie',
      radius: ['50%', '70%'], // 核心：缩小内外半径（原50%/70%）
      center: ['50%', '50%'], // 上移一点，避开图例
      roseType: 'area',
      label: { show: false }, // 核心：隐藏扇区文字标签
      data: []
    }
  ],
  graphic: {
